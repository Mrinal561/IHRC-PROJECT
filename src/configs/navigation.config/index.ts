        ...
        subMenu: [
            {
                ...
                subMenu: [
                    ...
                    // {
                    //     key: 'companySetup.collapse.entitySetup.collapse.item8',
                    //     path: '/userAccess',
                    //     title: 'User Access',
                    //     translateKey: 'nav.companySetup.collapse.entitySetup.collapse.item8',
                    //     icon: '',
                    //     type: NAV_ITEM_TYPE_ITEM,
                    //     authority: [],
                    //     subMenu: [],
                    // },
                    {
                        key: 'companySetup.collapse.entitySetup.collapse.item7',
                        path: '/Edit-permission',
                        title: 'Edit Permission',
                        translateKey: 'nav.companySetup.collapse.entitySetup.collapse.item7',
                        icon: '',
                        type: NAV_ITEM_TYPE_ITEM,
                        authority: [],
                        subMenu: [],
