...
const navigationConfig: NavigationTree[] = [
    ...
    },
    {
        ...
        subMenu: [
            {
                key: 'companySetup.collapse.item1',
                path: '/company-group',
                title: 'Company Group',
                translateKey: 'nav.companySetup.collapse.item1',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            ...
            {
                key: 'companySetup.collapse.item2',
                path: '/company-name',
                title: 'Company',
                translateKey: 'nav.companySetup.collapse.item2',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            ...
            {
                key: 'companySetup.collapse.item3',
                path: '/branch',
                title: 'Branch',
                translateKey: 'nav.companySetup.collapse.item3',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
            ...
            {
                key: 'companySetup.collapse.item4',
                path: '/branch-agreements',
                title: 'Branch Agreements',
                translateKey: 'nav.companySetup.collapse.item4',
                icon: '',
                type: NAV_ITEM_TYPE_ITEM,
                authority: [],
                subMenu: [],
