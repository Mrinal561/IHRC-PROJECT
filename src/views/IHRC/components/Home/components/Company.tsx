...
//   // Initialize companies using the first company group
//   const initializeCompanies = async () => {
//     try {
//       setIsLoading(true);
//       // First, get company groups
//       const { data: groupData } = await httpClient.get(endpoints.companyGroup.getAll(), {
//         params: { ignorePlatform: true },
//       });

//       if (groupData.data && groupData.data.length > 0) {
//         const firstGroupId = groupData.data[0].id;
        
//         // Then load companies using the first group's ID
//         const { data: companyData } = await httpClient.get(endpoints.company.getAll(), {
//           params: {
...
//         if (companyData?.data) {
//           const formattedCompanies = companyData.data.map((company: any) => ({
//             label: company.name,
//             value: String(company.id),
//           }));
...
//         }
//       } else {
//         showNotification('warning', 'No company groups found');
//       }
//     } catch (error: any) {
...
//     } catch (error) {
//       console.error('Failed to load location:', error);
//       showNotification('danger', 'Failed to load locations');
//       setLocation([]);
//     } finally {
//       setIsLoadingBranches(false);
//     }
...
//   // Load Branches based on selected Location
//   const loadBranches = async (locationId: string, locationName: string) => {
//     setIsLoadingBranches(true);
//     try {
//       const { data } = await httpClient.get(endpoints.branch.getAll());
...
//         return branchLocationId === locationId || branchLocationName === selectedLocationName;
//       });
...
//         showNotification('info', 'No branches found for this location');
//       }
...
//   // Load location when district changes
//   useEffect(() => {
//     if (selectedDistrict?.value) {
//       setSelectedLocation(null);
//       setSelectedBranch(null);
