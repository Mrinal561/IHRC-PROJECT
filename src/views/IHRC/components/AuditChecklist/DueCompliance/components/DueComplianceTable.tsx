...
interface DueComplianceTableProps {
    ...
    onUpdateStatus: (
        complianceId: number,
        newStatus: DueComplianceDataRow['Status'],
    ) => void
}
...
const DueComplianceTable: React.FC<DueComplianceTableProps> = ({
    data,
    onUploadSingle,
    onUpdateStatus,
}) => {
    ...
    const [selectedCompliance, setSelectedCompliance] =
        useState<DueComplianceDataRow | null>(null)
    ...
    const onSubmit = useCallback(() => {
        if (selectedCompliance && selectedStatus) {
            ...
            try {
                onUploadSingle(
                    selectedCompliance.Compliance_Instance_ID,
            ...
            console.warn(
                'Submit clicked without selectedCompliance or selectedStatus',
            )
        }
        onDialogClose()
    }, [
    ...
    return (
        <div className="relative">
            ...
            <Dialog isOpen={dialogIsOpen} onClose={onDialogClose}>
                ...
                {selectedCompliance?.Proof_Of_Compliance_Mandatory ===
                    'Yes' && (
                    <>
