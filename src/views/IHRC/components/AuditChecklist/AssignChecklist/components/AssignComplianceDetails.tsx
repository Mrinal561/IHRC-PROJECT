...
// // Import the interface for StatusDataRow
// import {ChecklistDataRow} from './AssignChecklistTable';
...
//   const complianceData = state as ChecklistDataRow;
...
//           />
//         </div>
//         <h3 className="mb-2 lg:mb-0">Assigned Compliance Details</h3>
//       </div>
...
export default AssignComplianceDetails;