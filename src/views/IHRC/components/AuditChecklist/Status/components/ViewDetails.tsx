...
import { StatusDataRow } from './StatusTable'; // Import the interface for StatusDataRow
...
const ComplianceDetails: React.FC = () => {
  ...
  const complianceData = state as StatusDataRow;
  ...
  return (
    <AdaptableCard className="p-4">
      ...
      <div className="border p-2 rounded-md mb-2">
        ...
        <p className="text-sm mb-2"><strong>Compliance Status:</strong> {complianceData.Compliance_Status}</p>
      </div>
      ...
      <div className="border p-4 rounded-md">
        ...
        <div className="flex gap-6">
          ...
          {/* Second inner box */}
          <div className="w-1/2">
            <p className="text-sm mb-2"><strong>Owner:</strong> {complianceData.Owner}</p>
            <p className="text-sm mb-2"><strong>Approver:</strong> {complianceData.Approver}</p>
            <p className="text-sm mb-2"><strong>Uploaded Date:</strong> {complianceData.Uploaded_Date}</p>
            ...
            <p className="text-sm mb-2"><strong>Compliance Month Date:</strong> {complianceData.Compliance_Month_Date}</p>
          </div>
        </div>
      </div>
    </AdaptableCard>
