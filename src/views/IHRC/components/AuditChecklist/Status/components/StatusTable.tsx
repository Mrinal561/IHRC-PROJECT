...
const StatusTable: React.FC<StatusTableProps> = ({
    ...
    const handleConfirmReject = (reason: string) => {
        if (currentRejectId !== null) {
            ...
            toast.push(
                <Notification title="Compliance Rejected" type="warning">
                ...
                cell: ({ row }) => (
                    <Checkbox
                        checked={selectedItems.has(
                            row.original.Compliance_Instance_ID,
                        )}
                        onChange={() => {
                    ...
                    return (
                        <div className="flex items-center">
                            ...
                            {status === 'Rejected' && rejectionRemark ? (
                                <Tooltip
                                    title={`Rejection Reason: ${rejectionRemark}`}
                                    placement="top"
                                >
                            ...
                            {(status === 'pending' ||
                                ...
                                <Tooltip title="View Compliance Detail">
                                    <Button
                                        ...
                                        onClick={() =>
                                            navigate(
                                                `/app/IHRC/compliance-status-list-detail/${row.original.Compliance_Instance_ID}`,
                                                { state: row.original },
                                            )
                                        }
                                        icon={<RiEyeLine />}
