...
//     // Fetch already assigned compliances
//     useEffect(() => {
...
//             setTableData(prev => ({
//                 ...prev,
//                 total: data.length + assignedItems.size
//             }))
//         }
//     }, [data, initialLoadComplete, assignedItems])
...
//                 cell: ({ row }) => (
//                     <div className="w-2">
//                         {assignedItems.has(row.original.id) ? (
...
//                             }
//         ],
//         [selectedItems, filteredData, isAllSelected, isIndeterminate, assignedItems, branchValue, companyGroupValue, companyValue, stateValue, districtValue, locationValue, handleTableRerender]
//     );
...
//             <DataTable
//                 columns={columns}
//                 data={[...data, ...Array.from(assignedItems).map(id => data.find(item => item.id === id)!)]}
//                 skeletonAvatarColumns={[0]}
//                 skeletonAvatarProps={{ className: 'rounded-md' }}
