...
// import { deleteTracker, resetDeleteStatus } from '@/store/slices/pftracker/pfTrackerSlice';
...
//   const { isDeleted, error: deleteError } = useSelector((state: RootState) => state.tracker);
