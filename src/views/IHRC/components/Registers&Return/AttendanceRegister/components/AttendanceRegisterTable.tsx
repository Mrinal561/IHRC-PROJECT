...
//             {
//                 header: 'Present',
//                 accessorPath: 'summary.presentDays',
//                 cell: (props) => (
//                     <div className="w-16 truncate text-center">{props.getValue()}</div>
//                 ),
//             },
//             {
//                 header: 'WFH',
//                 accessorPath: 'summary.wfh',
//                 cell: (props) => (
//                     <div className="w-16 truncate text-center">{props.getValue()}</div>
//                 ),
//             },
...
//             {
//                 header: 'PL',
//                 accessorPath: 'summary.totalPaidLeave',
//                 cell: (props) => (
//                     <div className="w-16 truncate text-center">{props.getValue()}</div>
//                 ),
//             },
//             {
//                 header: 'UL',
//                 accessorPath: 'summary.totalUnpaidLeave',
//                 cell: (props) => (
//                     <div className="w-16 truncate text-center">{props.getValue()}</div>
//                 ),
//             },
//             {
//                 header: 'MS',
//                 accessorPath: 'summary.missingSwipeDays',
//                 cell: (props) => (
//                     <div className="w-16 truncate text-center">{props.getValue()}</div>
//                 ),
//             },
//             {
//                 header: 'WO',
//                 accessorPath: 'summary.weeklyOffs',
//                 cell: (props) => (
//                     <div className="w-16 truncate text-center">{props.getValue()}</div>
//                 ),
//             },
