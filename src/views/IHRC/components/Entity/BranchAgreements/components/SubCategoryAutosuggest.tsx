...
//   const handleCreateSubCategory = async (categoryName: string) => {
//     if (isCreating) return; // Prevent multiple submissions while creating
...
//               onClick={() => !isCreating && handleCreateSubCategory(value)}
//             >
//               {isCreating ? (
//                 <>
//                   <AiOutlineLoading3Quarters className="animate-spin mr-2" />
//                   Creating subcategory "{value}"...
//                 </>
//               ) : (
//                 <>Press Enter to create subcategory "{value}"</>
//               )}
//             </div>
//           ) : (
//             <div className="p-2 text-gray-500">No subcategories found</div>
...
const SubCategoryAutosuggest = ({ 
  ...
  // New function to fetch all subcategories
  ...
  // Initial fetch of all subcategories
  useEffect(() => {
    fetchAllSubCategories();
  }, []);

  // Modified search effect to filter existing subcategories or fetch new ones
  useEffect(() => {
    const searchSubCategories = async () => {
      if (!value) {
