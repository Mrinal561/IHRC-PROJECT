...
const PTSetupPanel: React.FC<PTSetupSidePanelProps> = ({
    ...
    const handleSignatoryChange = (
        ...
        if (
            ...
            actionMeta.option?.value === 'add_new'
        ) {
            setShowAddSignatoryDialog(true)
            handleInputChange(
                'authorizedSignatories',
                selectedSignatories.filter((name) => name !== 'add_new'),
            )
        }
    }
    ...
    const handleSubmit = () => {
        if (
            PTSetupData.ptState &&
            PTSetupData.ptLocation &&
            PTSetupData.authorizedSignatories.length > 0
        ) {
    ...
    const handleNewSignatoryInputChange = (
                    ...
                    <div className=" w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('Company_Group_Name', value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('ptState', value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('ptLocation', value)
                            }
                        />
                    </div>
                </div>
                    ...
                    <div className="w-full">
                        <DatePicker
                            ...
                            onChange={(date: Date | null) =>
                                handleInputChange('ptRegistrationDate', date)
                            }
                            size="sm"
                        />
                    </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('ptUserId', value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('ptPassword', value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('signatoryEmail', value)
                            }
                        />
                    </div>
                </div>
            ...
            <div className="flex gap-4 items-center">
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="w-full">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('signatoryMobile', value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="w-full flex flex-col gap-2">
                    ...
                    <OutlinedInput
                        ...
                        onChange={(value: string) =>
                            handleInputChange('ptecPaymentFrequency', value)
                        }
                    />
                </div>
                <div className="w-full flex flex-col gap-2">
                    ...
                    <OutlinedInput
                        ...
                        onChange={(value: string) =>
                            handleInputChange('ptrcPaymentFrequency', value)
                        }
                    />
                </div>
            </div>
            ...
            >
                ...
                <div className="space-y-4">
                    <OutlinedInput
                        ...
                        onChange={(value) =>
                            handleNewSignatoryInputChange('name', value)
                        }
                    />
                    <OutlinedInput
                        label="Designation"
                        ...
                        onChange={(value) =>
                            handleNewSignatoryInputChange('designation', value)
                        }
                    />
                    <OutlinedInput
                        label="Mobile"
                        ...
                        onChange={(value) =>
                            handleNewSignatoryInputChange('mobile', value)
                        }
                    />
                    <OutlinedInput
                        label="Email"
                        ...
                        onChange={(value) =>
                            handleNewSignatoryInputChange('email', value)
                        }
                    />
                </div>
                <div className="flex justify-end space-x-2 mt-4">
                    <Button onClick={() => setShowAddSignatoryDialog(false)}>
                        Cancel
                    </Button>
                    <Button variant="solid" onClick={handleAddSignatory}>
                        Add Signatory
                    </Button>
                </div>
            </Dialog>
