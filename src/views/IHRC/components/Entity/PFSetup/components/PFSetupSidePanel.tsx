...
const PFSetupSidePanel: React.FC<PFSetupSidePanelProps> = ({
    ...
    const handleSubmit = () => {
        if (
            pfSetupData.pfCode &&
            pfSetupData.pfCodeLocation &&
            pfSetupData.authorizedSignatory
        ) {
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-[352px]">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('pfCode', value)
                            }
                        />
                    </div>
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-[352px]">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('pfCodeLocation', value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-[352px]">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('pfUserId', value)
                            }
                        />
                    </div>
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="w-[352px]">
                        <OutlinedInput
                            ...
                            onChange={(value: string) =>
                                handleInputChange('pfPassword', value)
                            }
                        />
                    </div>
                </div>
            ...
            <div className="flex gap-4 items-center">
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <div className="">
                        <Select
                            isMulti
                            options={existingSignatories.map((s) => ({
                                value: s.name,
                                label: s.name,
                            }))}
